...
from ..utils.resnet import resnet101, resnet50

# Reference
# https://github.com/leaderj1001/PSPNet/tree/master/pspnet.py
...
class PSPNet(nn.Module):
    def __init__(self, params):
        ...
        self.decoder = nn.Sequential(
            ...
            nn.Dropout(0.1),
            nn.Conv2d(self.depth, self.n_classes, kernel_size=1),
        )

        self.aux = nn.Sequential(
            ConvBlock(1024, self.depth // 2, kernel_size=3),
            nn.Dropout(0.1),
    ...
    def forward(self, images, label=None):
        ...
        out = upsample(out, size=images.size()[-2:])
